...
```bash
conda create -n demo_classifier python=3.9
conda activate demo_classifier
```
...
- To trigger the release pipeline, get the current version from the `demo_classifier/__init__.py` file and tag the current code version:
```
